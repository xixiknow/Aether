...
fn map_proxy_group_row(row: &SqliteRow) -> Result<StoredProxyGroup, DataLayerError> {
...
fn map_proxy_group_member_row(row: &SqliteRow) -> Result<StoredProxyGroupMember, DataLayerError> {
